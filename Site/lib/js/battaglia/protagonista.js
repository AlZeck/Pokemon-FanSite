window.addEventListener("load", function() {
    ...
    //oggetto vue per le informazioni del giocatore corrente (protagonista)
    var protag = new Vue({
        ...
        methods: {
            ...
            //metodo per cambiare il pokemon attivo in base a quello selezionato (controlla se è esausto nel dom)
    ...
    //TESTING
    protag.aggiungiPkm(venusaur);
    protag.aggiungiPkm(ivysaur);
    protag.aggiungiPkm(bulbasaur);
    protag.aggiungiPkm(charizard);
    protag.aggiungiPkm(charmeleon);
    protag.aggiungiPkm(charmander);
